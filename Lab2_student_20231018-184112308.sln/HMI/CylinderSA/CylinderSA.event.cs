...
namespace HMI.Main.Symbols.CylinderSA
{
  partial class sDefault
  {
    ...
    private event EventHandler<HMI.Main.Symbols.CylinderSA.INDEventArgs> IND_Fired;
      ...
      switch(eventIndex)
      {
        ...
        case 0:
          if (IND_Fired != null)
          {
            try
            {
              IND_Fired(this, new HMI.Main.Symbols.CylinderSA.INDEventArgs(channelId, cookie, eventIndex));
            }
