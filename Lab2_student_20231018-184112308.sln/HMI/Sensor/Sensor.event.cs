...
namespace HMI.Main.Symbols.Sensor
{
  ...
  public class INDEventArgs : System.EventArgs
  {
    ...
    public bool Get_SensorRear(ref System.Boolean value)
    {
    ...
    public System.Boolean? SensorRear
    { get {
      if (accessorService == null)
        return null;
      bool var = false;
    ...
    public bool Get_SensorPosition(ref System.Single value)
    {
      if (accessorService == null)
        return false;
      float var = 0;
    ...
    public System.Single? SensorPosition
    { get {
      if (accessorService == null)
        return null;
      float var = 0;
